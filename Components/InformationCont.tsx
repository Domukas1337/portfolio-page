...
export default function InformationCont({
  ...
  return (
    <div className="flex flex-col w-fit lg:w-1/4 bg-gray-800/50 hover:bg-gray-500/50 backdrop-blur-3xl px-10 py-8 rounded-2xl shadow-2xl mx-2 transition-colors">
      {icon}
