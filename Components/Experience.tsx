export default function Experience({
  ...
  return (
    <div className="bg-gray-800/50 px-10 py-8 rounded-2xl shadow-2xl w-full lg:w-2/3">
      <div className="flex flex-col sm:flex-row lg:items-center justify-between">
        <h1 className="text-2xl font-bold">{title}</h1>
        <p className="text-purple-300 bg-purple-300/10 px-4 py-1 rounded-full w-1/2 sm:w-fit mt-2 sm:mt-0">
